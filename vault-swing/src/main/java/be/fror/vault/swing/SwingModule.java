...
public class SwingModule extends AbstractModule {
  ...
  private <I> void hear(TypeLiteral<I> literal, TypeEncounter<I> encounter) {
    encounter.register((InjectionListener) this::registerListener);
  }

  private void registerListener(Object injectee) {
